...
For example, the Tendermint client `Header` looks like [this](https://github.com/cosmos/ibc-go/blob/main/modules/light-clients/07-tendermint/tendermint.pb.go#L198):
...
<!-- TODO: update for client refactor v7 -->
