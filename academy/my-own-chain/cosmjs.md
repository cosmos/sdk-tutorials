...
[CosmJS](https://github.com/cosmos/cosmjs) is a library created to _talk_ to the Cosmos SDK. It is a [powerful tool](https://github.com/cosmos/cosmjs/wiki/What-can-CosmJS-do-for-me%3F), which can be used to create wallets, explorers, IBC relayers, and other decentralized applications (dApps). It is written in TypeScript and therefore, can be used either on client or server side.

In this section, you will have a look at code generated by Starport to understand the basics of the CosmJS library.
...
6. The created elements `txClient` and `queryClient` are returned to namely be used in `./vue/src/store/generated/alice/checkers/alice.checkers.checkers/index.js` - as you can see in the [previous Starport section](./starport.md).
