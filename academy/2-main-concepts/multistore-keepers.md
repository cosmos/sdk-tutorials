...
To create the above boilerplate in your module, you can use Ignite CLI. Go to Week 2 - Running Your Own Cosmos Chain, for more on Ignite CLI, and if you want to go beyond out-of-context code samples to see more in detail how to define these features.
