...
After having taken a look at the Go relayer, it is now time to turn to the Hermes relayer in the [next section](https://interchainacademy.cosmos.network/academy/ibc/hermesrelayer.html).
