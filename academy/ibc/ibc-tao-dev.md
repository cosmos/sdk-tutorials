...
order:
description: Establishing connections in IBC - Connections
tag: deep-dive
---
...
Now that you finished having a look at connections in IBC/TAO, it is now time to switch your focus to channels in the [next section](https://interchainacademy.cosmos.network/academy/ibc/channels.html).
