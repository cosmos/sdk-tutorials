...
```protobuf [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/proto/checkers/stored_game.proto#L17]
message StoredGame {
    ...
    string winner = 11;
}
...
```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/types/full_game.go#L53-L72]
...
```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/types/errors.go#L22]
...
```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/keeper/msg_server_create_game.go#L32]
...
...
1. Check that the game has not finished yet:
    ...
    ```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/keeper/msg_server_play_move.go#L23-L25]
...
2. Update the winner field, which [remains neutral](https://github.com/batkinson/checkers-go/blob/a09daeb/checkers/checkers.go#L165) if there is no winner yet:
    ...
    ```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/keeper/msg_server_play_move.go#L62]
...
3. Handle the FIFO differently depending on whether the game is finished or not:
    ...
    ```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/keeper/msg_server_play_move.go#L69-L73]
    if storedGame.Winner == rules.PieceStrings[rules.NO_PLAYER] {
...
```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/keeper/msg_server_reject_game.go#L21-L23]
if storedGame.Winner != rules.PieceStrings[rules.NO_PLAYER] {
    return nil, types.ErrGameFinished
}
```
...
```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/keeper/msg_server_play_move_fifo_test.go#L49]
...
```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/keeper/msg_server_play_move_winner_test.go#L11-L17]
...
```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/keeper/msg_server_play_move_winner_test.go#L19-L63]
var (
...
```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/keeper/msg_server_play_move_winner_test.go#L65-L70]
...
```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/36fde2c/x/checkers/keeper/msg_server_play_move_winner_test.go#L72-L125]
