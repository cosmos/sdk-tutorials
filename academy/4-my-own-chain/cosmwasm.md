...
Familiarizing yourself with the following sections is recommended as a preparation:
...
This concludes Week 3. In the week to come, it is time to introduce a fundamental feature of Cosmos: cross-chain communication, which is achieved through the Inter-Blockchain Communication (IBC) Protocol.

Dive into the [next chapter](/course-ida/landingpages/week4-lp.md) to continue your journey.
