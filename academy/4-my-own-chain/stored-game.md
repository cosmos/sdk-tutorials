...
Now that you have added some code on top of what Starport created for you, it would be welcome to add unit tests. You are not going to add code to test the code generated by Starport as your project is not the right place to _test the framework_.

On the other hand, Starport added some unit tests of its own. Run those for the keeper with:
