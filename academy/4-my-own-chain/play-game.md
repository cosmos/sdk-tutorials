...
* Add the missing fields to the response in `proto/checkers/tx.proto`:
    ...
    ```protobuf [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/proto/checkers/tx.proto#L25-L30]
...
```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/types/errors.go#L14-L18]
...
1. Fetch the stored game information:
    ...
    ```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move.go#L16-L19]
    ...
    Using the [`Keeper.GetStoredGame`](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/stored_game.go#L17) function created by Ignite CLI.

2. Is the player legitimate? Check with:

    ```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move.go#L22-L29]
    ...
    Using the certainty that the `MsgPlayMove.Creator` has been verified [by its signature](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/types/message_play_move.go#L29-L35).

3. Instantiate the board in order to implement the rules:

    ```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move.go#L32-L35]
    ...
    Good thing you previously created [this helper](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/types/full_game.go#L27-L37).

4. Is it the player's turn? Check with:

    ```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move.go#L36-L38]
    if !game.TurnIs(player) {
        return nil, types.ErrNotPlayerTurn
    }
    ```

    Using the rules file's own [`TurnIs`](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/rules/checkers.go#L145-L147) function.

5. Properly conduct the move:

    ```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move.go#L41-L53]
    ...
    Using the rules' [`Move`](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/rules/checkers.go#L274-L301) function.

6. Prepare the updated board to be stored and store the information:

    ```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move.go#L56-L58]
    storedGame.Game = game.String()
    storedGame.Turn = rules.PieceStrings[game.Turn]
    k.Keeper.SetStoredGame(ctx, storedGame)
    ```

    Updating the fields that were modified using the [`Keeper.SetStoredGame`](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/stored_game.go#L10) function just as when you created and saved the game.

7. Return relevant information regarding the move's result:

    ```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move.go#L61-L66]
...
Adding unit tests for this play message is very similar to what you did for the previous message. Just create a new `msg_server_play_move_test.go` file and add to it. You can start by a function that sets up the keeper to your liking. In this case, already having a game saved can save you a few lines of code in each test:

```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move_test.go#L15-L26]
...
Then again, it is a case of testing the result of a move:

```go [https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move_test.go#L28-L45]
...
And whether the game was [saved correctly](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move_test.go#L47-L73). Also check what happens when players try to [play out of turn](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move_test.go#L75-L87), or [make a wrong move](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move_test.go#L89-L101). Check after [two](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move_test.go#L103-L164) or [three turns with a capture](https://github.com/cosmos/b9-checkers-academy-draft/blob/5657d5c/x/checkers/keeper/msg_server_play_move_test.go#L166-L243).
