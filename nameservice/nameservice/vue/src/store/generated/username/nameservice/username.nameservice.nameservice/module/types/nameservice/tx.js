...
const baseMsgCreateWhois = { owner: "", name: "", price: 0 };
...
const baseMsgUpdateWhois = { owner: "", id: 0, name: "", price: 0 };
...
const baseMsgDeleteWhois = { owner: "", id: 0 };
...
export class MsgClientImpl {
    ...
    CreateWhois(request) {
        ...
        const promise = this.rpc.request("username.nameservice.nameservice.Msg", "CreateWhois", data);
        return promise.then((data) => MsgCreateWhoisResponse.decode(new Reader(data)));
    }
    UpdateWhois(request) {
        const data = MsgUpdateWhois.encode(request).finish();
        const promise = this.rpc.request("username.nameservice.nameservice.Msg", "UpdateWhois", data);
        return promise.then((data) => MsgUpdateWhoisResponse.decode(new Reader(data)));
    }
    DeleteWhois(request) {
        const data = MsgDeleteWhois.encode(request).finish();
        const promise = this.rpc.request("username.nameservice.nameservice.Msg", "DeleteWhois", data);
