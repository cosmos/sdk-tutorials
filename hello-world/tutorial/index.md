...
By completing this tutorial, you've learned to build an IBC module for the Cosmos SDK, build your own blockchain app, and use the Inter-Blockchain Communication protocol (IBC). Here's what you accomplished in this tutorial:
