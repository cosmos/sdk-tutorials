...
* Have Go installed.
* The checkers blockchain with the elements necessary for forfeit:
    * Either because you followed the [previous steps](./03-starport-11-game-winner).
    * Or because you checked out [its outcome](https://github.com/cosmos/b9-checkers-academy-draft/tree/game-winner).
