...
`interchanged tx ibcdex cancel-sell-order [port] [channel] [amountDenom] [priceDenom] [orderID]`

`interchanged tx ibcdex cancel-buy-order [port] [channel] [amountDenom] [priceDenom] [orderID]`
