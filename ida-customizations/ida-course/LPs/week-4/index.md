...
After, take a deeper dive into all that IBC has to offer by first tackling [IBC denoms](/tutorials/6-ibc-dev/index.md), [playing with some cross-chain tokens](/hands-on-exercise/2-ignite-cli-adv/10-wager-denom.md), and [taking a look at relaying with IBC](/academy/25-cosmos-concepts/13-relayer-intro.md).
